...
|---------|------------|----------------------------------|
| HEADER  | 1 byte     | Tipo de mensaje (1=Apuesta, 2=Confirmación) |
| LENGTH  | 3 bytes    | Longitud del cuerpo del mensaje  |
| BODY    | N bytes (variable)    | Mensaje serializado en JSON      |


El Header consta de 1 byte con dos tipos de mensaje: con valor	1 = Apuesta, 2 = Confirmación, para poder detectar que tipo de mensaje se recibe o envía.

Se optó por 3 bytes de longitud como para dejar un margen mayor por si el nombre o apellido llegara a ser muy largo.

Luego la información es enviada en el mensaje, con serialización y deserializacion en su recepción y envío. También está contemplado las transformaciones de little endian a big endian, para evitar posibles errores en la transmisión.
