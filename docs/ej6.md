...
Para poder funcionar es necesario descomprimir primero el dataset para obtener los 5 archivos `.csv` que contiene el proyecto, trasladandose al directorio del proyecto y descomprimiendo por ejemplo de la siguiente manera:

```bash
cd ${path_del_proyecto}/tp0-base/.data/
unzip dataset.zip
```
